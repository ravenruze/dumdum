...
<style>
    ...
    h1 { font-size: 24px; margin-bottom: 25px; border-bottom: 2px solid #1e4d2b; padding-bottom: 10px; }
    h2 { font-size: 16px; margin-top: 30px; margin-bottom: 15px; display: flex; align-items: center; justify-content: space-between; }
    h2 a { font-size: 12px; color: #4c9b77; text-transform: none; text-decoration: none; }
    ...
    .kpi-card.accent { border-left-color: #1e4d2b; }
    .kpi-card.warning { border-left-color: #f6ad55; }
    ...
    .bg-success { background: #d1e7dd; color: #1e4d2b; }
    ...
    .btn-action:hover { color: #1e4d2b; text-decoration: underline; }
...
<div class="laporan-container">
    ...
    <h3>{{ $semuaData ? 'Ringkasan Seluruh Periode' : 'Ringkasan Terfilter (' . \Carbon\Carbon::parse($dari)->format('d/m/Y') . ' - ' . \Carbon\Carbon::parse($sampai)->format('d/m/Y') . ')' }}</h3>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-weight: 600; color: #4c9b77;">Rp{{ number_format($pesanan->pembayarans->sum('jumlah_bayar'), 0, ',', '.') }}</td>
                </tr>
                @empty
                <tr>
                    <td colspan="4" style="text-align:center; color: #999; padding: 20px;">Belum ada record data transaksi penjualan.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="4" style="text-align:center; color: #999; padding: 20px;">Katalog kosong, tidak ada stok sapi tersedia.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <div class="table-container">
        <table>
            ...
            <tbody>
                ...
                @empty
                <tr>
                    <td colspan="6" style="text-align:center; color: #999; padding: 20px;">Tidak ada pesanan sapi berjalan.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
